  ...
  renderCard(`
    ...
    <div class="settings-card">
      ...
      <div class="settings-item"
           onclick="showAlertModal('เร็ว ๆ นี้','ฟังก์ชันตั้งค่าการแจ้งเตือนจะเปิดให้ใช้งานในเร็ว ๆ นี้')">
      ...
      <!-- 👤 ความยินยอม -->
      <div class="settings-item"
           onclick="showAlertModal('การจัดการความยินยอม','สามารถจัดการความยินยอมได้ในเมนูนี้เร็ว ๆ นี้')">
        <div class="settings-icon">👤</div>
      ...
      <!-- 📄 เงื่อนไข -->
      <div class="settings-item"
           onclick="showAlertModal('ข้อกำหนดและเงื่อนไข','รายละเอียดข้อกำหนดการใช้งานจะเปิดแสดงในเร็ว ๆ นี้')">
        <div class="settings-icon">📄</div>
