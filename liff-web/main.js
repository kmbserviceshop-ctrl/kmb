...
function openConsentDetail() {
  ...
  renderCard(`
<div class="top-bar">
  <button class="back-btn" onclick="showConsentPage()">←</button>
...
<div class="section-card">
  ...
  >
    ...
    การเก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคลจะดำเนินการตามกฎหมาย
    คุ้มครองข้อมูลส่วนบุคคลที่เกี่ยวข้องอย่างเคร่งครัด<br><br>
    ...
    <ul>
      ...
      <li>ยืนยันตัวตน และป้องกันการทุจริต</li>
      <li>แจ้งเตือนสถานะบิลและข้อมูลสำคัญ</li>
      <li>ติดต่อประสานงานกับร้านค้า</li>
      <li>ปรับปรุงคุณภาพและความปลอดภัยของระบบ</li>
    </ul>

    <strong>3. การเปิดเผยข้อมูล</strong><br>
    KPOS จะไม่เปิดเผยข้อมูลส่วนบุคคลแก่บุคคลภายนอก
    เว้นแต่เป็นไปตามกฎหมาย หรือได้รับความยินยอมจากท่าน<br><br>

    <strong>4. ระยะเวลาการจัดเก็บข้อมูล</strong><br>
    จัดเก็บเท่าที่จำเป็นตามวัตถุประสงค์และข้อกำหนดทางกฎหมาย<br><br>
    ...
    <ul>
      ...
      <li>ขอให้ลบหรือระงับการใช้ข้อมูล</li>
    </ul>

    <strong>6. การถอนความยินยอม</strong><br>
    สามารถถอนความยินยอมได้ในเมนูตั้งค่า
    โดยการถอนอาจส่งผลให้ไม่สามารถใช้บริการ KPOS Connect ได้
  </div>
  ...
  box.addEventListener("scroll", () => {
    ...
    if (nearBottom) {
      scrolledToEnd = true;
      if (READ_TIMER_PASSED) btn.disabled = false;
    }
  });
